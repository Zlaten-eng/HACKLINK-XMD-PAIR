              ...
              if (qr) await res.end(await QRCode.toBuffer(qr));
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, HACKLINK-XMD User!* 👋🏻

Thanks for using *HACKLINK-XMD* — your session has been successfully created!
...
contextInfo: {
externalAdReply: {
title: "HACKLINK-XMD 𝕮𝖔𝖓𝖓𝖊𝖈𝖙𝖊𝖉",
thumbnailUrl: "https://files.catbox.moe/elhfta.jpg",
